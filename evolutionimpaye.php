    ...
    <section class="container">
        ...
        <form method="POST" action="evolutionimpaye.php">
            ...
            if ($_POST['choix']=='4'){
                ...
                echo '<input type="radio" id="date" name="choix" value="date" checked /> entre 2 dates<br><br>';
        ...
        <?php if ($_POST['choix']=='date'){ echo "<h1> Fonctionnalité en cours de développement...</h1>";} ?>
        <div style="width:70%;">
        <canvas id="myChart">
        <script>
            <?php
