                ...
                if (isset($_POST['mdp2']) && isset($_POST['mdp'])) {
                    ...
                    if ($mdp == $mdp2) {
                        ...
                        if ($_SESSION['typeu'] == 0) {
                            ...
                            echo "<br><div style='color: white'><a href=\"tresorerie_utilisateur.php\" class='white_link'>Cliquez ici</a> pour aller sur la page d'accueil</div>";
                        } else if ($_SESSION['typeu'] == 1) {
                            unset($_SESSION['mdpProvisoire']);
                            echo "<br><div style='color: white'><a href=\"admin_demande.php\" class='white_link'> Cliquez ici</a> pour aller sur la page d'accueil</div>";
                            $cnx->exec("UPDATE utilisateur SET nbr_essai=0 WHERE mail='" . $_SESSION['login'] . "';");
