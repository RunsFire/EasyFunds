        ...
        <section class="table-display">
            ...
            <div id="po-par-client-display" class="display active">
                ...
                <div class="frame filtres">
                    <form method="POST" action="impayes_utilisateur.php">
                        <?php
                    ...
                    <div class="table-datas shorter-table">
                        <table class="frame">
                            ...
                            if (!empty($_POST['resets'])) {
                                unset($_SESSION['filtre5']);
                                unset($_SESSION['croissance5']);
                                unset($_POST['filtre5']);
                                unset($_POST['croissance5']);
                                unset($_POST['resets']);
                            }
                            if (!empty($_POST['filtre5']) && !empty($_POST['croissance5'])) {
                                $_SESSION['filtre5'] = $_POST['filtre5'];
                                $_SESSION['croissance5'] = $_POST['croissance5'];
                            }
                            if (isset($_SESSION['filtre5']) &&  isset($_SESSION['croissance5'])) {
                                $tresorerie = $cnx->query("SELECT SIREN,raison_sociale,date_vente,date_remise,NCarte,reseau,numero_impaye,montant,code_impaye FROM impaye WHERE num_utilisateur= $num AND SIREN LIKE \"" . $_SESSION['siren3'] . "\" AND raison_sociale  LIKE \"" . $_SESSION['raison3'] . "\" AND date_vente >= \"" . $_SESSION['date3'] . "\" AND date_remise<= \"" . $_SESSION['date4'] . "\" AND numero_impaye LIKE   \"" . $_SESSION['numdossier'] . "\" ORDER BY " . $_SESSION['filtre5'] . " " . $_SESSION['croissance5'] . ";");
                            } else {
