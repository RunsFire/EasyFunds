...
<body>
    <section class="container">
        ...
        <?php if ($_POST['choix']=='date'){ echo "<h4 class='alert'> Fonctionnalité en cours de développement...</h4>";} ?>
        ...
        <script>
            ...
            document.getElementById('exportPdf').addEventListener('click', async function () {
                ...
                pdf.addImage(chartImage, 'PNG', 10, 10, 260,150); // (image, format, x, y, width, height)
