function exportTableToPdf(data, nom_fichier, nom_client, siren) {
    ...
    if (nom_client != "" && siren != "") {
        // on recupere le nom du fichier pour savoir si on export des remises, des impayes ou des transactions(tresorerie)
        ...
        // on change la taille du text
        doc.setFontSize(15);

        // si la page la page est tresorerie alors on remplace par transactions
        // si la page est detail alors on remplace par details remises
