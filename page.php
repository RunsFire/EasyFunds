    ...
    <section class="container">
        ...
        <section>
            ...
            <div class="frame options">
                ...
                <input type="radio" class="option-radio" name="option" id="tous-clients" checked>
                <label for="tous-clients" class="option-label" onclick="displayTable('tous-clients', 'po-tous-clients-display')">Trésorerie des comptes clients</label>

                <!-- TRÉSORERIE PAR COMPTE CLIENT -->
                <input type="radio" class="option-radio" name="option" id="par-client">
                <label for="par-client" class="option-label" onclick="displayTable('par-client', 'po-par-client-display')">Trésorerie par compte client</label>
        ...
        <section class="table-display">
            ...
            <!-- PO TOUS CLIENTS, remplit par défaut -->
            <div id="po-tous-clients-display" class="display active">

                <!-- FILTRES -->
                <div class="frame filtres">
                    <form action="nomDuFichier.php?display='po-tous-client'" method="get">
                ...
                <div class="frame row-space-between" style="margin-top: 2px;">
                    ...
                    <form class="table-export" onsubmit="return false">
                        ...
                        <button onclik="exporter('po-tous-clients-display')">Exporter</button>
                    </form>
                </div>
            ...
            <div id="po-par-client-display" class="display">
                <!-- FILTRES -->
